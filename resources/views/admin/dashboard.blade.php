                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="flex-between gap-8 mb-24">
                                        <span class="flex-shrink-0 w-48 h-48 flex-center rounded-circle bg-warning-600 text-white text-2xl"><i class="ph-fill ph-users-four"></i></span>
                    ...
                    <div class="col-xxl-3 col-sm-6">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                               ...
                               <div class="">
                                    <span class="text-gray-200 text-lg mb-12 mt-10 d-block text-center">Total activity</span>
                                    ...
                                    <div class="mt-20">
                                        <div class="bg-primary-50 rounded-16 p-12 flex-between flex-wrap gap-8 mb-16">
                                            ...
                                            <span class="px-16 py-4 rounded-pill bg-white border border-primary-600 text-primary-600 fw-medium">In Progress</span>
                                        </div>
                                        <div class="bg-success-50 rounded-16 p-12 flex-between flex-wrap gap-8 mb-0">
                                            ...
                                            <span class="px-16 py-4 rounded-pill bg-white border border-success-600 text-success-600 fw-medium">Completed</span>
                                        </div>
                                    </div>
                                    <!-- Progress Card End -->
                               </div>
