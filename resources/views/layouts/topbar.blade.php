            ...
            <div class="card border border-gray-100 rounded-12 box-shadow-custom">
                <div class="card-body">
                    ...
                    <ul class="max-h-270 overflow-y-auto scroll-sm pe-4">
                        ...
                        <form id="logoutForm" action="{{ url('/admin/logout') }}" method="POST" class="d-none">
                            @csrf
                        </form>
                        <li class="pt-8 border-top border-gray-100">
                            <button id="logoutButton" class="py-12 text-15 px-20 hover-bg-danger-50 text-gray-300 hover-text-danger-600 rounded-8 flex-align gap-8 fw-medium text-15">
