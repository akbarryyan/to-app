        ...
        <div class="lg:w-1/2 px-5 xl:pl-12 pt-10">
          ...
          <div class="max-w-[460px] m-auto pt-24 pb-16">
            ...
            <form id="registerForm" action="{{ route('user.register') }}" method="POST">
              ...
              <button type="submit" id="signupButton" class="py-3.5 flex items-center justify-center text-white font-bold bg-success-300 hover:bg-success-400 transition-all rounded-lg w-full">
